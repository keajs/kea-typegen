...
export interface loadersLogicType<Dashboard> {
    ...
    actionCreators: {
        ...
        addDashboardSuccess: (dashboard: Dashboard) => ({
        ...
        addDashboardNoTypeSuccess: (dashboard: Dashboard | null) => ({
            type: "add dashboard no type success (samples.loadersLogic)";
            payload: {
                dashboard: Dashboard | null;
            };
        });
        addDashboardNoTypeFailure: (error: string) => ({
