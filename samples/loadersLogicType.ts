// Generated by kea-typegen on Wed, 23 Jun 2021 10:25:19 GMT. DO NOT EDIT THIS FILE MANUALLY.
...
export interface loadersLogicType extends Logic {
    actionCreators: {
        ...
        addDashboardNoTypeSuccess: (dashboard: Dashboard) => {
        ...
        loadItSuccess: (misc: { id: number; name: void; pinned: boolean }) => {
            type: 'load it success (loadersLogic)'
            payload: {
                misc: { id: number; name: void; pinned: boolean }
            }
        }
        loadItFailure: (error: string) => {
